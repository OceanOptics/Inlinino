...
PyInstaller.__main__.run([
    ...
    # plotly hidden imports
    # '--hidden-import=plotly.validators.layout.template',
    # '--hidden-import=plotly.validators.layout.font',
    # '--hidden-import=plotly.validators.layout.xaxis',
    # '--hidden-import=plotly.validators.layout.yaxis',
    # '--hidden-import=plotly.validators.layout.legend',
    # '--hidden-import=plotly.validators.layout.template.data',
    # '--hidden-import=plotly.validators.barpolar',
    # '--add-data=%s%s%s' % (os.path.join(PATH_TO_SITE_PACKAGES, 'plotly', 'package_data', 'templates', '*.json'), OS_OPERATOR, os.path.join('plotly', 'package_data', 'templates')),
    '--clean',
    '--noconfirm',
    # '--debug=all',
    '--windowed',
